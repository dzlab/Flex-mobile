...
package com.baao.sql
{
	...
	public class SQLiteService extends EventDispatcher
	{
		 ...
		 * 
		 */
		protected function execute(statementText:String, responder:Responder, itemClass:Class = null, prefetch:int = -1.0) : void
		{
			//Statement problem modification
			//=============== BEGIN ADDITION ===============//
			statement = new SQLStatement();
		...
		public function executeAsync(statement:String, dataType:Class = null, prefetch:int = -1.0) : AsyncToken
		{
			...
			{
				execute(statement, requesthandler.responder, dataType, prefetch);
				return token;				
			}
